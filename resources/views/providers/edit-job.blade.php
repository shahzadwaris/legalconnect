          ...
          <div class="white-box">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="settings">
                <form class="form-horizontal form-material" action="{{route('provider.job.update',$job->id)}}"
                  method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="form-group">
                    <label class="col-md-12">Job Title</label>
                    <div class="col-md-12">
                      <input type="text" class="form-control form-control-line" name="title" value="{{$job->jobTitle}}"
                        required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <div class="radio radio-info">
                        <input type="radio" name="type" {{$job->type == 'Full Time' ? 'checked' : ''}} id="radio34"
                        value="Full Time">
                        <label for="radio34"> Full Time </label>
                      </div>

                      <div class="radio radio-info">
                        <input type="radio" name="type" {{$job->type == 'Temporary' ? 'checked' : ''}} id="radio33"
                        value="Temporary">
                  ...
                  <div class="row">
                    <div class="col-md-3" style="margin-top: .3rem;">
                      <div class="form-group">
                        ...
                        {{-- <div class="col-md-12"> --}}
                          <input type="text" class="form-control form-control-line" name="zip" value="{{$job->zip}}"
                            required>
                          {{--
                        </div> --}}
                      </div>
                    ...
                    <div class="col-md-3 ml-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="length" class="form-control" value="{{$job->jobLength}}">
                      </div>
                    </div>
                    <div class="col-md-3 ml-4">
                      <div class="form-group">
                        <label class="control-label">Shift/Hours </label>
                        <input type="text" name="hours" class="form-control" value="{{$job->shiftHours}}">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <textarea class="form-control form-control-line" rows="5" name="more">{{$job->about}}</textarea>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group m-t-10"> <span class="input-group-addon"><i
                          ...
                          <input type="text" id="example-input3-group1" style="padding-left: 1rem;" name="pay"
                            class="form-control" value="{{$job->salary}}" placeholder="3000-6000">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group" style="margin-top: 1.2rem;">
                        ...
                        <div class="col-md-12">
                          <select name="pay_type" class="form-control" id="category">
                            ...
                            <option value="Daily" {{$job->pay_type == 'Daily' ? 'selected' : ''}}>Daily</option>
                            <option value="Weekly" {{$job->pay_type == 'Weekly' ? 'selected' : ''}}>Weekly</option>
                            <option value="Yearly" {{$job->pay_type == 'Yearly' ? 'selected' : ''}}>Yearly</option>
                      ...
                      <div class="form-group" style="margin-top: 1.2rem;">
                        ...
                        <div class="col-md-12">
                          <select name="category" class="form-control" id="category">
                            ...
                            <option value="{{$category->slug}}" {{$category->slug == $job->category ? 'selected' :
                  ...
                  <div class="form-group">
                    ...
                    if($job->specialties)
                    {
                    $experiences = explode(',', $job->specialties);
                    }
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="checkbox checkbox-info">
                          ...
                          'checked'
                          : '' }} name="specialties[]" value="{{$item->title}}">
