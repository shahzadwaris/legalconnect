...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('admin.category.create')}}"
                    class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus"></i> Add
                    New</a>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">All Categories/Professions</h6>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-danger ml-5"
                                    ...
                                    href="{{route('admin.category.destroy',$category->id)}}"><i
