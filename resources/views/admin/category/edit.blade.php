...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal form-material" action="{{route('admin.category.update', $category->id)}}"
                method="POST" />
            @csrf
            <div class="form-group">
                <label for="title" class="font-weight-bold">Category/Profession Title</label>
                <input type="text" class="form-control" name="title" value="{{$category->title}}" id="title"
                    placeholder="Category Title">
            </div>
            <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <button type="submit" class="btn btn-primary btn-block mt-5">Update Category</button>
                </div>
                <div class="col-md-2"></div>
            </div>
            </form>
