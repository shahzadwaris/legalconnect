...
<head>
    ...
    <title>@yield('title') - Med Connect</title>

    <!-- Custom fonts for this template-->
    <link href="{{asset('bootstrap-admin/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
    ...
    <link href="{{asset('bootstrap-admin/css/styles.css')}}" rel="stylesheet">
    @yield('css')
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Medical Workers -->
            <li class="nav-item {{request()->routeIs('admin.show') ? 'active' : ''}}">
            ...
            <li class="nav-item">
                ...
                <div id="pages" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('page.nurse-terms')}}">Nurse Terms & Condition</a>
                        <a class="collapse-item" href="{{route('page.mpTerms')}}">MP Terms & Condition</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('bootstrap-admin/img/undraw_profile.svg')}}">
                            </a>
    ...
    {{--
    <!-- Page level plugins -->
    <script src="{{asset('bootstrap-admin/vendor/chart.js/Chart.min.js')}}"></script>

    <!-- Page level custom scripts -->
    <script src="{{asset('bootstrap-admin/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('bootstrap-admin/js/demo/chart-pie-demo.js')}}"></script> --}}
    @yield('js')
    <script>
        $(function(){
