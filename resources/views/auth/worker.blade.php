            ...
            {{-- <div class="section-top-border"> --}}
                <div class="row">
                    <div class="col-lg-8 offset-md-2">
                        <h3 class="mb-30 text-center">Legal Worker Registration</h3>
                        <form action="{{route('register')}}" method="POST" id="register">
                            ...
                            <div class="mt-2">
                                <div class="primary-checkbox" style="display: inline-block;">
                                    <input checked name="terms" type="checkbox" required id="default-checkbox">
                                    <label for="default-checkbox"></label>
                                </div>
                                <span>
                                    I have read and I agree to the <a class="text-danger"
                                        href="{{route('home.nurse.terms')}}" target="_blank">Terms and
                                        Conditions
                                </span>
                            </div>
                            <button type="submit" class="btn btn-block btn-block mt-4">Register</button>
                        </form>
                    </div>
                </div>
                {{--
